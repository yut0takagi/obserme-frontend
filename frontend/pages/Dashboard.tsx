...
const Dashboard = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Welcome Section */}
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center bg-gradient-to-r from-indigo-500 to-purple-600 rounded-2xl p-8 text-white shadow-lg">
        <div>
          <h2 className="text-3xl font-bold mb-2">おはようございます、太郎さん！ 👋</h2>
          <p className="text-indigo-100 opacity-90">今日は {pendingTasks.length} 個のタスクと {mockEvents.length} 件の予定があります。</p>
        </div>
        <div className="mt-4 md:mt-0">
          <Link to="/tasks">
            <Button className="bg-white text-indigo-600 hover:bg-indigo-50 border-none">スケジュールを確認</Button>
          </Link>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="flex items-center space-x-4">
          ...
          <div>
            <p className="text-sm text-gray-500 dark:text-gray-400">未完了タスク</p>
        ...
        <Card className="flex items-center space-x-4">
          ...
          <div>
            <p className="text-sm text-gray-500 dark:text-gray-400">今週の完了数</p>
        ...
        <Card className="flex items-center space-x-4">
          ...
          <div>
            <p className="text-sm text-gray-500 dark:text-gray-400">予定されている面接</p>
      ...
      <Card className="p-6">
        <div className="flex justify-between items-center mb-6">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-lg font-bold text-gray-800 dark:text-white">モチベーション推移 (過去2週間)</h3>
          </div>
          <Link to="/diary" className="text-sm text-indigo-600 dark:text-indigo-400 hover:underline">日記を書く</Link>
        </div>
        <div className="h-64">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="h-full">
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-lg font-bold text-gray-800 dark:text-white">最近の選考状況</h3>
            <Link to="/applications" className="text-sm text-indigo-600 dark:text-indigo-400 hover:underline">すべて見る</Link>
          </div>
        ...
        <Card className="h-full">
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-lg font-bold text-gray-800 dark:text-white">優先タスク</h3>
            <Link to="/tasks" className="text-sm text-indigo-600 dark:text-indigo-400 hover:underline">すべて見る</Link>
          </div>
          <div className="space-y-4">
